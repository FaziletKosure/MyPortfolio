    ...
    <div className="container py-5">
      <div className="row">
        <div className="col-lg-6 col-xm-12">
          <img className="profile-img" src={author} alt="author..." srcset="" />
        </div>
        <div className="col-lg-6 col-xm-12">
          <h1 className="about-heading">about me</h1>
          <p>
            Hello! I am Fazilet. I have been developing websites for over 1,5
            ...
            campaign for you in Google Fazilet and Facebook!
          </p>
        </div>
      </div>
    </div>
